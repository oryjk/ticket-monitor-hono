...
export const match_info_json = (lid2: string) => `
{
  "code": 1,
  "data": {
    "id": 44,
    ...
    "notices": [
      {
        ...
        "is_show": true,
        "rank": 5,
        "text": "本场比赛${lid2}本赛季采取强实名政策，购票采用实名制，凭本人身份证原件（必备）人脸识别入场。同一证件仅能对应一张门票，请球迷朋友们在购买前完成实名认证。如入场观赛者身份与所持球票身份信息不符，工作人员有权拒绝其入场并保留追究相关法律责任的权利。",
        "read_num": 0,
        "icon": "info-circle",
        "name_color": "#000000",
        "text_color": "#999999",
